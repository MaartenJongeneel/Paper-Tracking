...
%% Cuboid Tracking using Particle Filter with Non Smooth model and measurement L
% Settings
...
if DoSave
    GUPF_NS_L_Y = Y;
    save(sprintf(append('Results/','/GUPF_NS_L_P%dF%d'),Npart,maxt),'GUPF_NS_L_Y','runtime','GT','Z','K','AH_M','box','impacts');
end
...
figure('pos',[200 400 250 200]); 
    ...
    legend('GUPF\_NS\_L','L','location','southwest');
